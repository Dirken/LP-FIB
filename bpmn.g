...
process: (start|conex|file)*;

start: STARTP! operations ENDP! ID^;

/// ; > | > # > +
operations: ID  (OPENP! ((SEQ^|GOR^|GXOR^|GPAR^) ID)* CLOSEP!)*;

conex: CONN^ ID ID;

file: FILECONN^ ID (FILEREAD^|FILEWRITE^) ID;
///End of process operations.

///Begin of queries operations:
queries: (crit|dif|correctf)*;
